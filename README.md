...
Proyecto de software para la eficiencia de la tienda como el control de inventario, la gestion de ventas, compras y el control de la gestion de creditos en la tienda.
